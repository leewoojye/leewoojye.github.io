...
![alt text](/assets/images/wordembeddingmethods.png)
...
![alt text](/assets/images/hard_softparamsharing.png)
...
<!-- ![alt text](/assets/images/transfer_learning_taxonomy-1.png) -->
